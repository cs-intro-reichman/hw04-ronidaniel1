...
public class ArrCharOps {
    ...
    */
    public static char[] concat(char[] arr1, char[] arr2) {
        // Handle null inputs by treating them as empty (optional safety)
    ...
    public static long hashCode(char[] arr) {
        ...
        long hash = 0;
        /* The formula is a polynomial calculation. 
           Instead of using Math.pow which is slow, we can accumulate:
    ...
    public static int compareTo(String str1, String str2) {
        ...
        // Requirement says "Assume both strings are not empty", but explicit empty check handles edge cases correctly
        ...
        // If we finished the loop, one string is a prefix of the other, or they are identical
        if (len1 < len2) return -1;
        if (len1 > len2) return 1;
        
        return 0; // Lengths are equal and all chars matched
    }
}